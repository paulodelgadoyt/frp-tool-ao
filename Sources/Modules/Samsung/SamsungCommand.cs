...
{
    /// <summary>
    /// Comando do módulo Samsung
    /// </summary>
    public class SamsungCommand : IModuleCommand
    {
        private readonly string _operation;
        private readonly SamsungViewModel _viewModel;
        private readonly RelayCommand _command;

        public string Name => _operation;
        public string Description => $"Executa operação {_operation} para dispositivos Samsung";
        public System.Windows.Input.ICommand Command => _command;
        public bool CanExecute => !_viewModel.IsOperationRunning;

        public SamsungCommand(string operation, SamsungViewModel viewModel)
        {
