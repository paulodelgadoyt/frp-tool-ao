...
{
    public partial class AndroidAdbView : UserControl
    {
        private AndroidAdbViewModel _viewModel;
        private FlowLayoutPanel _commandsPanel;
        private Label _titleLabel;
        private Label _statusLabel;
        private Label _connectionLabel;

        public AndroidAdbView(AndroidAdbViewModel viewModel)
        {
        ...
        private void LoadCommands()
        {
            ...
            foreach (var command in _viewModel.Commands)
            {
                ...
                button.FlatAppearance.MouseOverBackColor = Color.LightGreen;
        ...
        {
            _connectionLabel.Text = _viewModel.IsAdbConnected 
                ? "ADB: Conectado" 
                : "ADB: Desconectado";
            _connectionLabel.ForeColor = _viewModel.IsAdbConnected 
                ? Color.Green 
                : Color.Red;
